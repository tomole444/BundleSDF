...
python run_custom.py --mode run_video --video_dir /home/thws_robotik/Documents/Leyh/6dpose/datasets/BuchVideo --out_folder outBuchTest --use_segmenter 1 --use_gui 0
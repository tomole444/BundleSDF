...
if __name__ == "__main__":
    bench = Benchmark(pose_pred_dir="/home/thws_robotik/Documents/Leyh/6dpose/detection/BundleSDF/outBuchVideoFeatureOffsetSpike/ob_in_cam",
    ...
    #bench.run_occlusion()
    bench.plot_results()
    bench.save_results("benchmarks/BuchVideo/ADD_BundleSDF_feature_matching_spike.npy")
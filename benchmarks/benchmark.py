...
def calcADD():
    bench = BenchmarkADD(pose_pred_dir="/home/thws_robotik/Downloads/outBuchVideoLoftrAnalysisFilterOff/ob_in_cam",#"/home/thws_robotik/Downloads/outBuchVideoPoseRegression-4/ob_in_cam",
    ...
    #bench.run_occlusion()
    bench.plot_results()
    bench.save_results("benchmarks/BuchVideo/ADD_Bundle_loftr_filter_off.npy")

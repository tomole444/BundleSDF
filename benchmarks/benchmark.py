...
def calcADD():
    bench = BenchmarkADD(pose_pred_dir="outBuchVideoTemplateLessRestrictions/ob_in_cam",#"/home/thws_robotik/Downloads/outBuchVideoPoseRegression-4/ob_in_cam",
    ...
    #bench.run_occlusion()
    bench.plot_results()
    bench.save_results("benchmarks/BuchVideo/ADD_Bundle_template_less_restrictions.npy")
